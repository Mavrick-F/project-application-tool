...
![Version](https://img.shields.io/badge/version-0.9.5-blue) ![Status](https://img.shields.io/badge/status-feature%20complete-brightgreen)
...
**Current Status:** v0.9.5 - Travel time reliability refinements with median LOTTR calculation and consistent result styling. Ready for v1.0 release.
